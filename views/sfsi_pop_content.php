...
<div class="pop-overlay upload-overlay" >
	...
	<!--<p>Link this icon in second step</p>-->
        <div class="sfsi_uploader">
            <div class="upload upload-another">
            	<label>Custom Icon:</label>
                <input name="" type="text" readonly="readonly"  />
                <input name=""  type="button" value="Upload" class="upload_butt" onclick="upload_image(this)" ajx_url="<?php echo plugins_url()."/ultimate-social-media-icons/ajax.php"?>"/>
            </div>
        </div>
