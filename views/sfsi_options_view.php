...
<div class="wapper sfsi_mainContainer">
    ...
    <div class="tab8">
	 ...
	 <p style="margin-top: 30px;">This plugin is 100% free. Please do us a Big favor and give us a 5 star rating <a href="https://wordpress.org/support/view/plugin-reviews/ultimate-social-media-icons" target="_new">here</a>. If you're not happy, please <a href="mailto:support@ultimatelysocial.com">getin touch with us.</a> so that we can sort it out.Thank you !</p>
    </div>
