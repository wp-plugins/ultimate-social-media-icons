     ...
     <script>
	    SFSI( document ).scroll(function( $ ) {
		 ...
		 var y = jQuery(this).scrollTop();
		  ...
		  SFSI('.sfsi_outr_div').css({'z-index':'1000000',opacity:1,top:SFSI(window).scrollTop()+"px",position:"absolute"});
		  ...
		  SFSI('.sfsi_FrntInner').fadeIn(200);
	       ...
	       if(SFSI(window).scrollTop() + SFSI(window).height() >= SFSI(document).height()-10) {
