   ...
   switch($icon_name)
    {
        ...
        case "facebook" :
		    ...
		    /* check for the over section */
                    ...
                    $visit_icon=$visit_iconsUrl."facebook.svg";
        ...
        case "google" :                    
		     ...
		     $twt_margin=$totwith/2;
                     ...
                     $visit_icon=$visit_iconsUrl."google.svg";
        ...
        case "youtube" :
		     ...
		     $totwith=$width+28+$icons_space;
                     ...
                     $visit_icon=$visit_iconsUrl."youtube.svg";
       ...
       case "pinterest" :
		     ...
		     $arrow_class="bot_pintst_arow";
                     ...
                     $visit_icon=$visit_iconsUrl."pinterest.svg";
	...
	case "instagram" :		 
        ...
        case "linkedin" :
		     ...
		     $arrow_class="bot_linkedin_arow";                
                     ...
                     $visit_icon=$visit_iconsUrl."linkedIn.svg";
                     /* check for icons to display */     
