...
function sfsi_depened_sections() {
    if ("sfsi" == SFSI("input[name='sfsi_rss_icons']:checked").val()) {
        ...
        var t = SFSI(".icon_img").attr("src"),
            n = t.replace("email.png", "sf_arow_icn.png");
...
//new custom icons uploaded from media uploader
function sfsi_newcustomicon_upload(custom_imgurl)
{
	var i = custom_imgurl,
        n = {
            action: "UploadIcons",
...
function sfsi_update_step1() {
    ...
    var s = !1,
        ...
        o = SFSI("input[name='sfsi_google_display']:checked").val(),
        a = SFSI("input[name='sfsi_share_display']:checked").val(),
...
function sfsi_update_step2() {
    ...
    var i = 1 == SFSI("input[name='sfsi_rss_url']").prop("disabled") ? "" : SFSI("input[name='sfsi_rss_url']").val(),
        ...
        _ = SFSI("textarea[name='sfsi_twitter_aboutPageText']").val(),
        l = 1 == SFSI("input[name='sfsi_google_page']").prop("disabled") ? "" : SFSI("input[name='sfsi_google_page']:checked").val(),
        S = 1 == SFSI("input[name='sfsi_googleLike_option']").prop("disabled") ? "" : SFSI("input[name='sfsi_googleLike_option']:checked").val(),
        u = SFSI("input[name='sfsi_google_pageURL']").val(),
        f = 1 == SFSI("input[name='sfsi_googleShare_option']").prop("disabled") ? "" : SFSI("input[name='sfsi_googleShare_option']:checked").val(),
        d = 1 == SFSI("input[name='sfsi_youtube_page']").prop("disabled") ? "" : SFSI("input[name='sfsi_youtube_page']:checked").val(),
        I = 1 == SFSI("input[name='sfsi_youtube_pageUrl']").prop("disabled") ? "" : SFSI("input[name='sfsi_youtube_pageUrl']").val(),
        m = 1 == SFSI("input[name='sfsi_youtube_follow']").prop("disabled") ? "" : SFSI("input[name='sfsi_youtube_follow']:checked").val(),
        F = SFSI("input[name='sfsi_ytube_user']").val(),
        h = 1 == SFSI("input[name='sfsi_pinterest_page']").prop("disabled") ? "" : SFSI("input[name='sfsi_pinterest_page']:checked").val(),
        v = 1 == SFSI("input[name='sfsi_pinterest_pageUrl']").prop("disabled") ? "" : SFSI("input[name='sfsi_pinterest_pageUrl']").val(),
        g = 1 == SFSI("input[name='sfsi_pinterest_pingBlog']").prop("disabled") ? "" : SFSI("input[name='sfsi_pinterest_pingBlog']:checked").val(),
        k = 1 == SFSI("input[name='sfsi_instagram_pageUrl']").prop("disabled") ? "" : SFSI("input[name='sfsi_instagram_pageUrl']").val(),
        y = 1 == SFSI("input[name='sfsi_linkedin_page']").prop("disabled") ? "" : SFSI("input[name='sfsi_linkedin_page']:checked").val(),
        b = 1 == SFSI("input[name='sfsi_linkedin_pageURL']").prop("disabled") ? "" : SFSI("input[name='sfsi_linkedin_pageURL']").val(),
        w = 1 == SFSI("input[name='sfsi_linkedin_follow']").prop("disabled") ? "" : SFSI("input[name='sfsi_linkedin_follow']:checked").val(),
        x = SFSI("input[name='sfsi_linkedin_followCompany']").val(),
        C = 1 == SFSI("input[name='sfsi_linkedin_SharePage']").prop("disabled") ? "" : SFSI("input[name='sfsi_linkedin_SharePage']:checked").val(),
        D = SFSI("input[name='sfsi_linkedin_recommendBusines']:checked").val(),
        U = SFSI("input[name='sfsi_linkedin_recommendProductId']").val(),
        O = SFSI("input[name='sfsi_linkedin_recommendCompany']").val(),
        T = {};
    SFSI("input[name='sfsi_CustomIcon_links[]']").each(function() {
        T[SFSI(this).attr("file-id")] = this.value
    });
    var P = {
        action: "updateSrcn2",
        sfsi_rss_url: i,
        ...
        sfsi_twitter_aboutPageText: _,
        sfsi_google_page: l,
        sfsi_googleLike_option: S,
        sfsi_google_pageURL: u,
        sfsi_googleShare_option: f,
        sfsi_youtube_page: d,
        sfsi_youtube_pageUrl: I,
        sfsi_youtube_follow: m,
        sfsi_ytube_user: F,
        sfsi_pinterest_page: h,
        sfsi_pinterest_pageUrl: v,
        sfsi_instagram_pageUrl: k,
        sfsi_pinterest_pingBlog: g,
        sfsi_linkedin_page: y,
        sfsi_linkedin_pageURL: b,
        sfsi_linkedin_follow: w,
        sfsi_linkedin_followCompany: x,
        sfsi_linkedin_SharePage: C,
        sfsi_linkedin_recommendBusines: D,
        sfsi_linkedin_recommendCompany: O,
        sfsi_linkedin_recommendProductId: U,
        sfsi_custom_links: T
    };
    SFSI.ajax({
        url: ajax_object.ajax_url,
...
function sfsi_update_step3() {
    ...
    var i = SFSI("input[name='sfsi_actvite_theme']:checked").val(),
        ...
        o = SFSI("#sfsi_mouseOver_effect option:selected").val(),
...
function sfsi_update_step4() {
    ...
    var e = SFSI("input[name='sfsi_display_counts']:checked").val(),
        ...
        a = SFSI("input[name='sfsi_google_api_key']").val(),
        ...
        h = 1 == SFSI("input[name='sfsi_google_countsDisplay']").prop("disabled") ? "" : SFSI("input[name='sfsi_google_countsDisplay']:checked").val(),
        v = 1 == SFSI("input[name='sfsi_google_countsFrom']").prop("disabled") ? "" : SFSI("input[name='sfsi_google_countsFrom']:checked").val(),
        g = SFSI("input[name='sfsi_google_manualCounts']").val(),
        ...
        P = SFSI("input[name='sfsi_youtube_user']").val(),
        j = 1 == SFSI("input[name='sfsi_pinterest_countsDisplay']").prop("disabled") ? "" : SFSI("input[name='sfsi_pinterest_countsDisplay']:checked").val(),
        ...
        R = 1 == SFSI("input[name='sfsi_shares_countsDisplay']").prop("disabled") ? "" : SFSI("input[name='sfsi_shares_countsDisplay']:checked").val(),
        W = 1 == SFSI("input[name='sfsi_shares_countsFrom']").prop("disabled") ? "" : SFSI("input[name='sfsi_shares_countsFrom']:checked").val(),
        q = SFSI("input[name='sfsi_shares_manualCounts']").val(),
        $ = {
            action: "updateSrcn4",
            ...
            sfsi_youtube_user: P,
            sfsi_pinterest_countsDisplay: j,
...
function sfsi_update_step5() {
    ...
    var v = 1 == SFSI("input[name='sfsi_rss_MouseOverText']").prop("disabled") ? "" : SFSI("input[name='sfsi_rss_MouseOverText']").val(),
        ...
        b = 1 == SFSI("input[name='sfsi_google_MouseOverText']").prop("disabled") ? "" : SFSI("input[name='sfsi_google_MouseOverText']").val(),
        ...
        U = 1 == SFSI("input[name='sfsi_share_MouseOverText']").prop("disabled") ? "" : SFSI("input[name='sfsi_share_MouseOverText']").val(),
        O = {};
...
function sfsi_update_step7() {
    ...
    var i = SFSI("input[name='sfsi_popup_text']").val(),
        ...
        t = (SFSI("#sfsi_popup_fontStyle option:selected").val(), SFSI("input[name='sfsi_popup_fontColor']").val()),
...
function afterLoad() {
    SFSI("input").removeClass("inputError"), SFSI(".save_button >a").html("Save"), SFSI(".tab8>div.save_button >a").html("Save All Settings"), SFSI(".save_button >a").css("pointer-events", "auto"), SFSI(".save_button >a").removeAttr("onclick"), SFSI(".loader-img").hide()
}
...
function sfsi_float_widget(s) {
    function i() {
        a = "Microsoft Internet Explorer" === navigator.appName ? o - document.documentElement.scrollTop : o - window.pageYOffset, Math.abs(a) > 0 ? (window.removeEventListener("scroll", i), o -= a * n, SFSI("#sfsi_floater").css({
            top: (o + e).toString() + "px"
        }), setTimeout(i, t)) : window.addEventListener("scroll", i, !1)
    }
    if ("center" == s) var e = window.innerHeight / 2;
    else if ("bottom" == s) var e = window.innerHeight - SFSI("#sfsi_floater").height();
    else var e = parseInt(s); {
        var t = 50,
            n = .1,
            o = 0,
            a = 0;
...
window.onerror = function(s) {}, SFSI = jQuery.noConflict(), SFSI(window).load(function() {
...
SFSI(document).ready(function(s) {
    ...
    SFSI("head").append('<meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate" />'), SFSI("head").append('<meta http-equiv="Pragma" content="no-cache" />'), SFSI("head").append('<meta http-equiv="Expires" content="0" />'), SFSI("#accordion").accordion({
        collapsible: !0,
        active: !1,
        heightStyle: "content",
        event: "click",
        ...
        onChange: function(s, i) {
            SFSI("#sfsi_popup_fontColor").val("#" + i), SFSI("#sfsifontCloroPicker").css("background", "#" + i), sfsi_make_popBox()
        },
        onClick: function(s, i) {
            SFSI("#sfsi_popup_fontColor").val("#" + i), SFSI("#sfsifontCloroPicker").css("background", "#" + i), sfsi_make_popBox()
        }
    }),
    SFSI('div#linkedin').find('.icon4').find('a').find('img').mouseover(function(){ SFSI(this).attr('src',ajax_object.plugin_url+'images/visit_icons/linkedIn_hover.svg');}),
    SFSI('div#linkedin').find('.icon4').find('a').find('img').mouseleave(function(){ SFSI(this).attr('src',ajax_object.plugin_url+'images/visit_icons/linkedIn.svg');}),
    SFSI('div#youtube').find('.icon1').find('a').find('img').mouseover(function(){ SFSI(this).attr('src',ajax_object.plugin_url+'images/visit_icons/youtube_hover.svg');}),
    SFSI('div#youtube').find('.icon1').find('a').find('img').mouseleave(function(){ SFSI(this).attr('src',ajax_object.plugin_url+'images/visit_icons/youtube.svg');}),
    SFSI('div#facebook').find('.icon1').find('a').find('img').mouseover(function(){ SFSI(this).css('opacity','0.9');}),
    SFSI('div#facebook').find('.icon1').find('a').find('img').mouseleave(function(){ SFSI(this).css('opacity','1');}),
    ...
    SFSI("#sfsiBackgroundColorPicker").ColorPicker({
        ...
        onChange: function(s, i) {
            SFSI("#sfsi_popup_background_color").val("#" + i), SFSI("#sfsiBackgroundColorPicker").css("background", "#" + i), sfsi_make_popBox()
        },
        onClick: function(s, i) {
            SFSI("#sfsi_popup_background_color").val("#" + i), SFSI("#sfsiBackgroundColorPicker").css("background", "#" + i), sfsi_make_popBox()
        }
        ...
        onChange: function(s, i) {
            SFSI("#sfsi_popup_border_color").val("#" + i), SFSI("#sfsiBorderColorPicker").css("background", "#" + i), sfsi_make_popBox()
        },
        onClick: function(s, i) {
            SFSI("#sfsi_popup_border_color").val("#" + i), SFSI("#sfsiBorderColorPicker").css("background", "#" + i), sfsi_make_popBox()
        }
    ...
    SFSI(".icn_listing").on("click", ".checkbox", function() {
        if (1 == e) return !1;
        "yes" == SFSI(this).attr("dynamic_ele") && (s = SFSI(this).parent().find("input:checkbox:first"), s.is(":checked") ? SFSI(s).attr("checked", !1) : SFSI(s).attr("checked", !0));
        s = SFSI(this).parent().find("input:checkbox:first"), "yes" == SFSI(s).attr("isNew") && ("0px 0px" == SFSI(this).css("background-position") ? (SFSI(s).attr("checked", !0), SFSI(this).css("background-position", "0px -36px")) : (SFSI(s).removeAttr("checked", !0), SFSI(this).css("background-position", "0px 0px")));
        ...
        SFSI("div.sfsi_wicons").css("z-index", "0"), SFSI(this).parent().parent().parent().siblings("div.sfsi_wicons").find(".inerCnt").find("div.sfsi_tool_tip_2").hide(), SFSI(this).parent().parent().parent().parent().siblings("li").length > 0 && (SFSI(this).parent().parent().parent().parent().siblings("li").find("div.sfsi_tool_tip_2").css("z-index", "0"), SFSI(this).parent().parent().parent().parent().siblings("li").find("div.sfsi_wicons").find(".inerCnt").find("div.sfsi_tool_tip_2").hide()), SFSI(this).parent().parent().parent().css("z-index", "1000000"), SFSI(this).parent().parent().css({
            ...
            opacity: 1,
            "z-index": 10
        }), SFSI(this).parent().css("opacity", "1")), SFSI(this).attr("effect") && "scale" == SFSI(this).attr("effect") && (SFSI(this).parent().addClass("scale"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").css({
            opacity: 1,
            "z-index": 10
        }), SFSI(this).parent().css("opacity", "1")), SFSI(this).attr("effect") && "combo" == SFSI(this).attr("effect") && (SFSI(this).parent().addClass("scale"), SFSI(this).parent().css("opacity", "1"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").css({
            opacity: 1,
            "z-index": 10
        })),  (('top-left' == i || 'top-right' == i) && (SFSI(this).parent().parent().parent().parent('#sfsi_floater').length>0 && SFSI(this).parent().parent().parent().parent().attr('id')=='sfsi_floater')) ? (SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").addClass("sfsi_plc_btm"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").find("span.bot_arow").addClass("top_big_arow"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").css({
            opacity: 1,
            "z-index": 10
        ...
        SFSI("div.sfsi_wicons").css("z-index", "0"), SFSI(this).parent().parent().parent().siblings("div.sfsi_wicons").find(".inerCnt").find("div.sfsi_tool_tip_2").hide(), SFSI(this).parent().parent().parent().parent().siblings("li").length > 0 && (SFSI(this).parent().parent().parent().parent().siblings("li").find("div.sfsi_tool_tip_2").css("z-index", "0"), SFSI(this).parent().parent().parent().parent().siblings("li").find("div.sfsi_wicons").find(".inerCnt").find("div.sfsi_tool_tip_2").hide()), SFSI(this).parent().parent().parent().css("z-index", "1000000"), SFSI(this).parent().parent().css({
            ...
            opacity: 1,
            "z-index": 10
        })), ((('top-left' == s || 'top-right' == s)) && (SFSI(this).parent().parent().parent().parent('#sfsi_floater').length>0 && SFSI(this).parent().parent().parent().parent().attr('id')=='sfsi_floater')) ? (SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").addClass("sfsi_plc_btm"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").find("span.bot_arow").addClass("top_big_arow"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").css({
            opacity: 1,
            "z-index": 10
        }), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").show()) : (SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").find("span.bot_arow").removeClass("top_big_arow"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").removeClass("sfsi_plc_btm"), SFSI(this).parentsUntil("div").siblings("div.sfsi_tool_tip_2").css({
            opacity: 1,
        ...
        SFSI(this).parent("div").find("div.sfsi_tool_tip_2_inr").css("opacity", "1"), SFSI(this).parent("div").find("div.sfsi_tool_tip_2_inr").show()
